...
> REVIEW WHAT THIS SCRIPT DOES PRIOR TO RUNNING: https://github.com/baseboxorg/dotfiles-automantic/blob/master/install.sh#L275-L1038
...
```bash
git clone --recurse-submodules https://github.com/baseboxorg/dotfiles-automantic ~/.dotfiles
cd ~/.dotfiles;
